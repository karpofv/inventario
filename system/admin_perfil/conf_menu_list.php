...
?>
    <div class="row-fluid" style="background: #FFFFFF;margin: 10px auto 10px auto;width: 80%;">
        ...
        if (msg) { $.ajax({ type: 'POST', url: 'accion.php', ajaxSend: $('#page-content').html(cargando),
...
<?php
                            if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                <a title="<?php echo 'Seleccionar '.$menu.'('.$submenu1.')'; ?>" 
                                   onclick="$.ajax({
                                                type: 'POST',
                                                url: 'accion.php',
                                                ajaxSend: $('#consultartd<?php echo $idSubMenuP; ?>').html(cargando),
                                                data: '&act=3&dmn=<?php echo $idMenut;?>&idsubmenupp=<?php echo $idSubMenuP; ?>&accC=<?php echo $accC; ?>&permiso=1&submenu=<?php echo $submenuID; ?>&menus=<?php echo $idmenus; ?>&idperfil=<?php echo $_POST[idperfil]; ?>',
...
<?php
                            if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                ...
                                onclick="$.ajax({ type: 'POST',
                                            url: 'accion.php',
                                            ajaxSend: $('#insertartd<?php echo $idSubMenuP; ?>').html(cargando),
                                            data: '&act=3&dmn=<?php echo $idMenut;?>&idsubmenupp=<?php echo $idSubMenuP; ?>&accI=<?php echo $accI; ?>&permiso=1&submenu=<?php echo $submenuID; ?>&menus=<?php echo $idmenus; ?>&idperfil=<?php echo $_POST[idperfil]; ?>',
                                            success: function(html) {
                            ...
                            if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                <a title="<?php echo 'Seleccionar '.$menu.'('.$submenu1.')'; ?>" 
                                   onclick="$.ajax({ 
                                                type: 'POST',
                                                url: 'accion.php',
                                                ajaxSend: $('#modificartd<?php echo $idSubMenuP; ?>').html(cargando),
                                                data: '&act=3&dmn=<?php echo $idMenut;?>&idsubmenupp=<?php echo $idSubMenuP; ?>&accM=<?php echo $accM; ?>&permiso=1&submenu=<?php echo $submenuID; ?>&menus=<?php echo $idmenus; ?>&idperfil=<?php echo $_POST[idperfil]; ?>',
                                                success: function(html) {
                            ...
                            if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                <a title="<?php echo 'Seleccionar '.$menu.'('.$submenu1.')'; ?>"
                                   onclick="$.ajax({
                                        type: 'POST',
                                        url: 'accion.php',
                                        ajaxSend: $('#eliminartd<?php echo $idSubMenuP; ?>').html(cargando),
                                        data: '&act=3&dmn=<?php echo $idMenut;?>&idsubmenupp=<?php echo $idSubMenuP; ?>&accE=<?php echo $accE; ?>&permiso=1&submenu=<?php echo $submenuID; ?>&menus=<?php echo $idmenus; ?>&idperfil=<?php echo $_POST[idperfil]; ?>',
                                        success: function(html) {
                            ...
                            if ($permiso_accion['S']==1 AND $permiso_accion['I']==1 AND $permiso_accion['U']==1 AND $permiso_accion['D']==1) { ?>
                                <a title="<?php echo 'Seleccionar '.$menu.'('.$submenu1.')'; ?>" 
                                   onclick="$.ajax({
                                        type: 'POST',
                                        url: 'accion.php',
                                        ajaxSend: $('#imprimirtd<?php echo $idSubMenuP; ?>').html(cargando),
                                        data: '&act=3&dmn=<?php echo $idMenut;?>&idsubmenupp=<?php echo $idSubMenuP; ?>&accImp=<?php echo $accImp; ?>&permiso=1&submenu=<?php echo $submenuID; ?>&menus=<?php echo $idmenus; ?>&idperfil=<?php echo $_POST[idperfil]; ?>',
                                        success: function(html) {
                                            $('#imprimirtd<?php echo $idSubMenuP; ?>').html(html); $('#thebutton').click();
                                        },
                                        error: function(xhr,msg,excep) {
                                            alert('Error Status ' + xhr.status + ': ' + msg + '/ ' + excep);
                                        }
